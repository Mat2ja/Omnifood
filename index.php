...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <!-- Tells phones to start the page with 100%, not zoomed out -->
    ...
    <body>
            ...
            <nav>
                <div class="row">
                    ...
                    <a class="mobile-nav-icon js--nav-icon">
                        <ion-icon name="menu" id="icon-change"></ion-icon>
                    </a>
                    <!-- <a class="mobile-nav-icon js--nav-icon"><i class="ion-navicon-round"></i></a> -->
                </div>
            </nav>
            <div class="hero-text-box">
                <!-- <h1 class="animated fadeInLeft slow">Goodbye junk food. <br> Hello super healthy meals.</h1> -->
        ...
        <section class="section-features js--section-features" id="features">
            ...
            <div class="row js--wp-1">
                <div class="col span-1-of-4 box">
                    ...
                    <!-- <ion-icon name="infinite-outline" icon-big"></ion-icon>-->
        ...
        <section class="section-testimonials">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-3">
                    <blockquote>
                        I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them
                        and
                        ended up with
        ...
        <section class="section-plans js--section-plans" id="plans">
            ...
            <div class="row">
                <div class="col span-1-of-3 tier">
                    ...
                    <form method="post" action="mailer.php" class="contact-form">
                        ...
                        <div class="row">
                            <div class="col span-1-of-3">
                                ...
                                <!--'for' in label links with 'id' in input so you can click on it-->
                            </div>
        ...
        <footer>
            <div class="row">
                ...
                <div class="col span-1-of-2">
                    <ul class="social-links">
                        ...
                        <li><a href="#">
                                <ion-icon name="logo-pinterest" class="logo-pinterest"></ion-icon>
                            </a></li>
                        <li><a href="#">
            ...
            <div class="row">
                <p>
                    Copright &copy; 2015 by Omnifood. All rights reserved.
                </p>
            </div>
        </footer>
        ...
        <script src="resources/js/script.js"></script> <!-- our script must be the last -->

        <!-- Global site tag (gtag.js) - Google Analytics -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-162091905-1"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag() { dataLayer.push(arguments); }
            gtag('js', new Date());

            gtag('config', 'UA-162091905-1');
        </script>
